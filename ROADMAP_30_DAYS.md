...
* **[x] Day 3**: Implement the message input container at the bottom of the chat window (auto-resizing text area, send button, Enter-to-submit).
...
* **[x] Day 7**: Connect the frontend chat interface to the `/api/v1/chat` endpoint using React state.
...
* **[x] Day 12**: Wire the SSE streaming reader into the Next.js chat page to show tokens rendering in real-time.
